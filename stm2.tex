...
\parbox[t]{2.3in}{Provide a full-sky map of dusty star forming galaxies. 
\vspace{1mm}
\hrule
\vspace{1mm}
Current knowledge:  \comred{To be completed} }&
\parbox[t]{2.7in}{Improve constraints on the parameters describing the rate of star-formation history}\\
\noalign{\vskip 1mm}
\hline
\noalign{\vskip 1mm}
