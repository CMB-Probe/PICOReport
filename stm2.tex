...
\hrule
\vspace{1mm}
Current knowledge:  \comred{??} }&
\parbox[t]{2.7in}{\comred{Investigate the distribution of cold (< 20 K) dust as a function of galaxy properties, such as morphology and stellar mass, with a statistical population only available using data at frequencies above 300~GHz}}\\
\noalign{\vskip 1mm}
\hline
\noalign{\vskip 1mm}
...
\parbox[t]{2.3in}{\comred{Provide a nearly full-sky map of matter fluctuations}. 
\vspace{1mm}
\hrule
\vspace{1mm}
Current knowledge:  \comred{??} }&
\parbox[t]{2.7in}{\comred{Improve constraints on the parameters describing the rate of star-formation history by an order of magnitude. Improve the constraint on the galaxy halo mass....}}\\
\noalign{\vskip 1mm}
\hline
\noalign{\vskip 1mm}
