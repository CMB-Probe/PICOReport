...
The 95\% CL bound on the amplitude of a scale-invariant rotation spectrum will be reduced by a factor of 275 to $4\times10^{-4}$~deg$^2$, potentially ruling out generic string-theory-motivated axions~\cite{Svrcek:2006yi,Pospelov:2008gg}.
