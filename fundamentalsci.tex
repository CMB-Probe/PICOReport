...
is expected 
to be strongest relative to the contribution from weak lensing and instrumental noise. \comor{best 
...
reach orders of magnitude \comor{how many?} higher decoupling temperatures and extend our knowledge of extensions 
...
Our baseline mission nearly reaches the target constraint with $g=1$. \comor{change the sentences below. Need to 
say what is Neff today. perhaps mentioned in the intro. Should we harp on 0.03 with 1sigma? Probably need to change the 
tone to talk about 2 sigma; then say the limits come from EE, so we can use large sky without worry of foregrounds}. 
...
a factor of five thus eliminating sub-MeV mass thermal relics. \comor{is this the latest forecast? for requirements
or CBE? this reminds me that there may be other parameters we are measuring to cosmic variance? Why not 
...
lies beyond the Standard Model: dark matter. \comor{SM not capitalized before} For a conventional WIMP candidate, the CMB places very stringent 
...
$m_{\rm dm}< 16$ GeV \comor{planck2018?} and a future CMB mission \comor{is this PICO? most recent forecast? for requirement 
or CBE?} could reach $m_{\rm dm} < 45$ GeV for $f_{\rm sky} =0.8$.  
The CMB provides the most stringent constraints on the dark matter annihilation cross section for dark matter 
in this mass range.  \comor{is there a figure for this?} 

% THIS IS ALSO EE, RIGHT?
