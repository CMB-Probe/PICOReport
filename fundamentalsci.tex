...
While the simplest modification to $\Neff$ arises from particles that decoupled long before neutrinos did, other particle production events, including at the time of light element synthesis few minutes after the bang leave an imprint on $\Neff$.   The CMB is particularly sensitive to changes in $\Neff$ arising from the production of helium, and thus to the abundance of helium, which is quantified through the helium fraction $Y_p$.  PICO will make a simultaneous measurement of $\Neff$ and $Y_p$ with $\sigma(\Neff) = 0.08$ and $\sigma(Y_p) =0.005$, respectively, giving a 2\% uncertainty on the value of $Y_p$. These uncertainties are equivalent to those available with other astrophysical measurements, but the systematic uncertainties are entirely different. Systematic uncertainties currently limit our knowledge of $Y_{p}$. 
