...
emission from elongated interstellar dust grains partially aligned with the local magnetic field. Although the levels of these foreground emissions decrease with decreasing angular scale, they can still be considerably brighter 
...
precisely characterized, or were known to have simple, fittable spectral emission laws. But neither is true. To a first approximation, the spectrum of synchrotron emission can be modeled as a power law $I_{\rm sync} \propto \nu^{\alpha},$ with $\alpha \simeq -1$. \comor{what about point sources, AME?}
