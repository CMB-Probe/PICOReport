...
small-scale kSZ power spectrum~\citep{calabrese/etal/2014}.
...
provide some large-scale information on the kSZ power spectrum).  Constraints from existing Planck data and observations at 
other wavelengths are also presented.  The PICO measurement of $\tau$ is essential for breaking degeneracies and a
llowing simultaneous precise constraints to be placed on both the mean redshift and duration of reionization.
