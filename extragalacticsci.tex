...
\vspace{0.1in}
\noindent{\bf Structure Formation via Gravitational Lensing} \hspace{0.1in} \label{gravitationallensing}
...
receives contributions from all redshifts between us and the CMB with the peak of the distribution at $z \simeq 2$, we infer the angular power spectrum $C_{L}^{\phi \phi}$. %, which depends on cosmological parameters \comor{why do we say that it depends on cosmological parameters? is that meant to connect to something later?}.
...
\hspace{-0.in}
\parbox{3.1in}{\centerline {
\includegraphics[width=3.0in]{images/PICO_fnl_lmin_PICOv4.1b_deproj0_SENS0.pdf} } }
\hspace{0.in}
\parbox{3.5in}{
...
\hspace{-0.in}
\parbox{3.1in}{\centerline {
\includegraphics[width=3.0in]{images/PICO_s8_lmax_PICOv4.1b_deproj0_SENS0.pdf} } }
\hspace{0.in}
\parbox{3.5in}{
...
\hspace{-0.1in}
\parbox{3.1in}{\centerline {
\includegraphics[width=3.0in]{images/m500lim_vs_z_pico_polar_v2.eps} } }
\hspace{0.in}
\parbox{3.4in}{
...
\vspace{0.1in}
\noindent{\bf Galaxy Formation via the Sunyaev-Zel'dovich (SZ) Effects} \hspace{0.1in} \label{sz}
