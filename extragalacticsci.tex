...
\hspace{0.1in}
\parbox{3.3in}{
\vspace{0.15in}\caption{\label{fig:sigma8constraint} Forecasted sensitivity to  the parameter describing the amplitude of structure in various redshift bins, as a function of the maximal multipole used in the analysis.  Percent-level constraints on these parameters allow for stringent tests of physics beyond $\Lambda$CDM that modify the rate of growth of structure. } }
\hspace{0.1in}
...
\vspace{0.1in}
\noindent{\bf Constraining Galaxy Formation via the Sunyaev-Zel'dovich (SZ) Effects} \hspace{0.1in} \label{sz}
