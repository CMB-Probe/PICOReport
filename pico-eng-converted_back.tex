...
\begin{figure}[!b]
  \begin{minipage}[b]{0.29\textwidth}
    \begin{center}
    \includegraphics[width=1.0in]{figures/InFairing.JPG}
...
%\vspace{-10pt} % move figure up to align with section headings.
\parbox{2.35in}{
...
%
\begin{wrapfigure}[22]{r}{0.35\textwidth}  % r is right aligned, l is left. Capital letters allow figure to float on page.
\centering
\vspace{-40pt} % move figure up to align with section headings.
