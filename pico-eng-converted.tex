...
%
\begin{wrapfigure}{R}{3.9in}  % r is right aligned, l is left. Capital letters allow figure to float on page.
\parbox{2.39in}{
...
220~GHz.\label{fig:pico_rendered} }
}
\end{wrapfigure}
%
...
\begin{wrapfigure}[28]{R}{0.4\textwidth}  % r is right aligned, l is left. Capital letters allow figure to float on page.
\includegraphics[width=0.4\textwidth]{figures/DirectAbsorbing.png}  %% figure was 2.5 in, .4 /textwidth is 2.6in.
\vspace{-0.25in}
