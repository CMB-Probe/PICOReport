...
Max power (MEV)&1320\,W (with 125\,\% margin on available solar array area)\\
...
\begin{figure}[!b]
  \begin{minipage}[b]{0.29\textwidth}
    \begin{center}
    \includegraphics[width=1.1in]{figures/InFairing.png}
...
\begin{center}
\caption{\captiontext 
  PICO technologies can be developed to TRL~5 prior to a 2023 Phase~A start using the APRA and SAT programs.\label{tab:technologies}}
...
90--150--220\,GHz \citep{Dutcher2018}. Other experiments have successfully deployed
...
coincidence rates \citep{SPIDER2018}. Residual
risk can be retired with 100\,mK testing where the array heat sinking may be weaker,
...
The full list of study report contributors and endorsers is on page~\ref{?}.
...
Pre-Phase A simulation software maturation is recommended to mitigate
the challenges associated with foreground separation
(\S\,\ref{sec:signal_separation}) and systematics control
