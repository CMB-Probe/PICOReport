...
\caption{\captiontext 
Detailed PICO instrument configuration. There are no moving or deployed parts. The spacecraft spun module accommodates warm instrument components: the 4\,K cooler compressor and drive electronics, the sub-K cooler drive electronics, and the detector warm readout electronics. {\color{red} Figure to be updated.}\label{fig:InstrumentCAD}}
\end{center}
\end{figure}
