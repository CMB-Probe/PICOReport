...
\parbox{3.0in}{
\caption{\captiontext 
  SPT-3G operates a focal plane with sinuous antenna-coupled, three-band pixels with more than 16,000 bolometers~\citep{Dutcher2018}. Each pixel couples radiation to bands at 90, 150, and 220~GHz. \comor{karl, how many pixels? how many detectors?}
  \label{fig:spt_fp} } }
\end{figure}
