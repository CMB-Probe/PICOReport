...
% \begin{wrapfigure}{L}{0.3\textwidth}  % r is right aligned, l is left. Capital letters allow figure to float on page.
% \includegraphics[width=0.40\textwidth]{figures/DirectAbsorbing.png}
% \vspace{-0.25in}
