...
%
 ...
 \catcode`!=\active
 \def!{\kern\signwidth}
\halign{\vtop{\hsize=1.5in\hangafter=1\hangindent=0.5em\strut#\strut}\tabskip 0.5em&
\vtop{\hsize=1.7in\hangafter=1\hangindent=0.5em\strut#\strut\tolerance=1000\par}&
\vtop{\hsize=1.7in\hangafter=1\hangindent=0.5em\strut#\strut\tolerance=1000\par}&
\vtop{\hsize=1.7in\hangafter=1\hangindent=0.5em\strut#\strut\tolerance=10000\par}\tabskip=0pt\cr
\noalign{\doubleline}
\noalign{\vskip 3pt}
...
\noalign{\vskip 3pt}
Sky coverage&Partial from single site&Partial from single flight&Full.    Most of sky observable nearly simultaneously with same detectors.\cr
%
Frequency coverage&Limited atmospheric windows. Minimum-foreground frequencies inaccessible. Frequencies $\ge300$\,GHz  unusable.& Better than ground. Minimum-foreground frequencies inacces-sible.&Unrestricted.\cr
%
Angular resolution&Telescope~cost function of size; arcmin resolution possible.&Small telescopes only.  Arcmin resolution impossible.&Telescope cost steep function of size.  Arcmin resolution expensive.\cr
%
Backgrounds and noise&Detector loading from ground and atmosphere, plus direct noise.  Individual detector sensitivity reduced substantially.&  Atmospheric loading less than from ground, greater than from space.&Only CMB, CIB, and Galactic backgrounds.  Direct-detector sensitivites roughly an order of magnitude better.\cr
%
...
\noalign{\vskip 3pt}
Accessibility, repairability&Good&None.  Multiple flights sometimes possible.&None.\cr
%
