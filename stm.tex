...
%\cline{1-2}
%\noalign{\vskip 1mm}
% \multicolumn{5}{l}{Cost~~\$100M} & \multicolumn{5}{l}{Mission length~~5 years} & \multicolumn{5}{l}{Launch mass~~2147~kg}  & \multicolumn{5}{l}{Total power~~1526~W} & & & \\ 
\noalign{\vskip 1mm}
%\hline
\end{tabular}
%
...
% parameters
%\centerline{
\begin{tabular}{r@{\hskip 0.06in}l@{\hskip 0.4in}r@{\hskip 0.06in}l@{\hskip 0.4in}r@{\hskip 0.06in}l@{\hskip 0.4in}r@{\hskip 0.06in}l}
\noalign{\vskip 1.0mm}
Cost & \$100M  & Mission length & 5 years & Launch mass & 2147~kg    & Total power   & 1526~W  
\end{tabular}
%}
%\begin{tabular}{r@{\hskip 0.06in}l|r@{\hskip 0.06in}l}
%Cost & \$100M  & Mission length & 5 years \\
%Launch mass & 2147~kg    & Total power   & 1526~W  %\\
%%\mutlicolumn{4}{c}{Combined map depth} \\
%%
