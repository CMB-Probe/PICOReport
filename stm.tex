...
\multicolumn{1}{l}{\parbox[t]{2in}{CMB polarization power spectra for modes $2<\ell<4000$; CMB intensity maps (to identify clusters using Compton $Y$ signal)}}&
...
$^b$ Using the PICO $\tau$ and $BB$ lensing power spectrum, and BAO from DESI or Euclid. \\
$^c$ The constraint using clusters requires redshifts by future optical and IR surveys% becomes available, \comred{and using  $\sigma_{8}$ from LSST}.
}
\end{table}
