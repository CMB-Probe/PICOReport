...
\multicolumn{1}{l}{\parbox[t]{2in}{Intrinsic polarization fractions of the warm and cold components of the diffuse interstellar medium to accuracy better than 2\% when averaged over 10 arcmin pixels; Temperatures and spectral indices of the two dust components to an accuracy \comred{better than??\%} }}&
