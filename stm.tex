...
Total power&1526\,W\cr
Mission length&5\,yr\cr
\multispan2Combined polarization map depth:\hfil\cr
\quad Baseline&0.87 $\mu$K$_{\rm CMB}$ equivalent to 3250 \textit{Planck} missions\cr
\quad CBE$^{a}$&0.61 $\mu$K$_{\rm CMB}$ equivalent to 6400 \textit{Planck} missions\cr
...
%\begin{table}[tb]
\caption{\textbf{Frequency Bands}\label{tab:spec_bands}}
\begingroup
%\openup 5pt
\newdimen\tblskip \tblskip=5pt
\nointerlineskip
...
\multicolumn{1}{l}{\parbox[t]{2in}{\textbf{SO5}. Distinguish between models that describe the formation of the earliest stars in the Universe (\S\,\ref{sec:extragalacticsci}, Fig.~\ref{fig:ReionizationPICO})}}&
