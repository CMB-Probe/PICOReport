...
\multicolumn{1}{l}{\parbox[t]{2in}{\textbf{SO6}. Constrain the temperatures and emissivities characterizing the Milky Way's interstellar dust (\S\,\ref{sec:test_composition_models})}}&
