...
PICO will provide all-sky maps of dust polarization at higher resolution than BLASTPol and with significantly higher sensitivity than {\em Planck}. Such a data set can only be obtained from a space mission. 
...
This in turn enables us to refine and test models of dust emission and grain alignment, which are of interest for the interpretation of dust polarization data at large.
