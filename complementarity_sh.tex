...
%
Frequency coverage & Limited atmospheric windows. $\nu=70$~GHz inaccessible. $\nu \ge 300$~GHz unusable.& Better than ground. $\nu=70$~GHz & Unrestricted \cr
%
Angular resolution& 1' resolution possible & $\gtrsim 4'$ possible & $\gtrsim 6'$ possible \cr
%
Detector Noise & $\ge xx$ microK rt(s); atmospheric 1/f noise requires subtraction &  $\ge xx$ microK rt(s) & $ xx$ microK rt(s)  \cr
%
Integration time  & Limited by Sun, weather & Limited by Sun, flight duration & Continuous, for years.\cr
%
%\noalign{\vskip 2pt}
