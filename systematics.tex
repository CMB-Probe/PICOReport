...
&
\planck's high-impedence bolometers with crosstalk measured at the level of 10$^{-3}$ did not impact CMB polarization science\cite{Planck_Lowell}.  Cross-talk of low-impedence bolometers measured at XXX.
&
...
Results of the simulation (neglecting foregrounds) are shown in Fig.~\ref{fig:calibration_spectra}. The scanning strategy employed by PICO allows for a much better calibration than Planck, thanks to the much faster precession.
