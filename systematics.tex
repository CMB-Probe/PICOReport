...
PICO takes advantage of an L2 orbit, implementing scans that are crosslinked on many time scales and at many angles, without interference from the Sun, Earth, or Moon, thus reducing the effects of low frequency noise (1/f) without additional modulation. 
