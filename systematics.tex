...
&
\\
Polarization Angle\dotfill& 
Uncertainty in polarization calibration leaks E$\to$B.
& 
Knowledge of astrophysical calibrators to 0.3$^\circ$\citet{Aumont+2018}; reconstruction to 0.2$^\circ$ using $TB$ and $EB$ demonstrated by \planck\citet{Planck_Lowell}
& 
Polarization modulation; See Sect.~\ref{sec:angle} for discussion; Must mitigate through developing further analysis techniques.
\\
...
&
Polarization modulation; State-of-the-art polarization gain calibration may be adequate.
\\
...
&
See Sect.~\ref{sec:gain}; Gain fluctuations on the level of XXX\% on time scales of YYY can be corrected in post-processing.
\\
\hline
\textbf{Straylight}& & \\
...
& 
Design of optical system and baffling, informed by telescope straylight.
&
See Sect.~\ref{sec:fsl} for a study of the \pico\ reference mission.\\
 \hline
\textbf{Other} \\
Residual correlated cosmic ray hits\dotfill&
detectors experience correlated cosmic ray hits below detection threshold
&
\planck\ /HFI found ...
&
Detector design to reduce cosmic ray cross-section; Current analysis techniques generating correlated noise simulations may be adequate.
\\
\hline
 \end{tabular}
\caption{\label{tbl:SystematicsList} Systematic errors expected to affect PICO's measurement of CMB polarization, with assessment of likely impacts and mitigation techniques.}
 \end{table}
