...
%The antenna pattern will be measured to levels lower than $-60$~dB from the main peak using scans of solar system planets~\citep{tauber2018}. The `far-sidelobe' pattern is typically below the noise level. 
