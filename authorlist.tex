...
\Large{ \centerline{February, 2019 }}
\vspace{6pt}
...
Brendan P. Crill $^{6}$                \\
Gianfranco De Zotti $^{34}$             \\
Jacques Delabrouille $^{5,12}$            \\
%Jacques Delabrouille $^{12}$           \\
%Mark Devlin $^{13}$   \\
Eleonora Di Valentino $^{35}$           \\
Joy Didier $^{36}$                      \\
Olivier Dor\'e $^{6,8}$                  \\
...
%J. Colin Hill $^{18}$                  \\
Eric Hivon $^{30}$                      \\
Ren\'{e}e  Hlo\v{z}ek $^{39}$           \\
Johannes Hubmayr $^{19}$                \\
Bradley R. Johnson $^{40}$              \\
William Jones $^{4}$                   \\
Terry Jones $^{1}$                     \\
Lloyd Knox $^{20}$                      \\
Al Kogut $^{21}$                        \\
Marcos L\'{o}pez-Caniego $^{41}$        \\
Charles Lawrence $^{6}$                \\
Alex Lazarian $^{42}$                   \\
Zack Li $^{4}$                         \\
...
34. INAF-Osservatorio Astronomico di Padova, Italy.  \\
...
39. Department of Astronomy \& Astrophysics and Dunlap Institute, University of Toronto, Canada.  \\
40. Columbia University.  \\
41. European Space Astronomy Centre.  \\
42. University of Wisconsin - Madison.  \\
43. Southern Methodist University.  \\
44. Cardiff University School of Physics and Astronomy.  \\
45. Northwestern University.  \\
46. Simon Fraser University.  \\
47. Stanford University.  \\
48. Kavli Institute for Particle Astrophysics and Cosmology.  \\
49. University of British Columbia, Canada.  \\
50. Harvard-Smithsonian Center for Astrophysics.  \\
51. Universit\`a degli studi di Milano.  \\
52. Institut d'Astrophysique Spatiale, CNRS, Univ. Paris-Sud, Universit\'e Paris-Saclay, France.  \\
53. San Diego Supercomputer Center, University of California, San Diego.
}
\end{multicols}
