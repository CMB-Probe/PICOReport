...
\normalsize{Executive Committee: \comred{May be incomplete } Jamie Bock, Julian Borrill, Brendan Crill, Mark Devlin, Raphael Flauger, Shaul Hanany (PI), William Jones, Lloyd Knox, Al Kogut, Charles Lawrence (ex-officio), Jeff McMahon, Clem Pryke, Amy Trangsrud (ex-officio)} \\
%\large{Contributors:} \\
%\large{Endorsers:} \\
