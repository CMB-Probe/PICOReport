...
\normalsize{Executive Committee: \comred{To be completed} Jamie Bock$^3$, Julian Borrill, Brendan Crill$^3$, Mark Devlin, Raphael Flauger, Shaul Hanany (PI), William Jones, Lloyd Knox, Al Kogut, Charles Lawrence$^3$ (ex-officio), Jeff McMahon, Clem Pryke$^1$, Amy Trangsrud$^3$ (ex-officio)} \\
%\large{Contributors:} \\
%\large{Endorsers:} \\
