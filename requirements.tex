...
(3) The PICO constraint on $N_{eff}$ (SO4) requires a determination of the $EE$ power spectrum to limits imposed by the statics of available $\ell$ modes. Full sky coverage is required to achieve this limit.  
...
%
$\bullet$ {\bf Frequency Bands} \hspace{0.1in} The multitude of astrophysical signals that PICO will characterize determine the frequency range and number of bands that the mission uses. The inflationary signal peaks in the frequency range between $\sim$60 and $\sim$300 GHz. However, Galactic signals, which are themselves signals PICO strives to characterize, are a source of confusion for the inflationary signal. The Galactic and cosmological  signals are separable through their spectral signatures. Simulations indicate that 21 bands, each with 25\% bandwidth, that are spread across the range of 20 - 800~GHz can achieve the separation at the level of fidelity required by PICO~(\S~\ref{sec:signal_separation}). 
