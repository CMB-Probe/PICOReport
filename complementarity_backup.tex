...
\noalign{\vskip 3pt}
Detector noise\,$^{c}$&$265\,\mu$K$_{\rm CMB}\sqrt{\rm s}$&$124\,\mu$K$_{\rm CMB}\sqrt{\rm s}$&$36\,\mu$K$_{\rm CMB}\sqrt{\rm s}$\cr
\noalign{\vskip 3pt}
Integration time&Unlimited&Weeks to a month&Continuous, for years\cr
\noalign{\vskip 3pt}
...
\hbox to 1em{$^{a}$}70\,GHz is the frequency at which large angular scale $B$-mode Galactic emissions have a minimum.\par
\hangafter=1\hangindent=1em\noindent\strut
\hbox to 1em{$^{b}$}We give representative approximate telescope aperture values. Significantly larger apertures for balloons and in space result in higher mass, volume, and cost.\par
\hangafter=1\hangindent=1em\noindent\strut
\hbox to 1em {$^{c}$}Noise-equivalent temperature: timestream-based median at 95\,GHz from BICEP3~\citep{kang20182017}; pre-flight expectation at 94\,GHz from SPIDER~\citep{2014SPIE.9153E..13R}; at 90\,GHz from PICO CBE.
} % close vbox
\endPlancktable
\endgroup
\end{table}
