...
% Author list on single seperate page
...
{***}\\
\bigskip
{The research was funded by a NASA grant NNX17AK52G to the University of Minnesota / Twin Cities, and by the Jet Propulsion Laboratory, 
California Institute of Technology, under a contract with the National Aeronautics and Space Administration, and by Lockheed Martin Corporation. 
Substantial contributions to this project were volunteered by scientists at many institutions world-wide. They are gratefully acknowledged.} \\
\bigskip
...
%48 remaining pages are distributed 29/19: 29 pages for science (including foregrounds and systematics), 19 for instrument, technology, mission, management and cost.
