...
\usepackage[font={small},margin=2em]{caption}
...
\titleformat{\subsubsection}
  {\normalfont\sffamily\itshape\color{MidnightBlue}}
...
\newpage
\section*{Export-Controlled Material Statement}

\centerline{This document has been reviewed and determined not to contain export controlled technical data.}
...
\subsection{Cosmological Legacy Surveys} % (2 pgs)
