...
% add a watermark.
\usepackage{draftwatermark} % use watermark
...
%The Science Traceability Matrix can be found in Tables~\ref{tab:STM} and \ref{tab:STM2}.
