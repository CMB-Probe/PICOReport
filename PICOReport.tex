...
48 pages are currently distributed as 31/17: 31 pages for science (including foregrounds and systematics), 17 for Instrument, technology, mission, technology, management and cost. References are extra. Should rebalance to 28/20? 

    \subsection{Introduction (1.5 pgs, Hanany + (Flauger? Green? +?)}
...
\subsection{Foregrounds (4 pgs, Clem? Jacques? Raphael? Brandon?)}
